...
class Feed extends Component {
    ...
    componentDidMount() {
        axios.get(URL+'/api/volunteers/me/', {
            ...
            .then(response => {
                this.setState({ profile: response.data, loaded:true });
    ...
    render() {
        ...
        const hasProfile = this.state.profile !== "";
                        ...
                        <div className="row justify-content-center align-content-start m-0">
                            ...
                            {hasProfile === false ?
                                <div className="col-12 col-lg-6 dash-button-box cp mx-0 mx-lg-2 my-1" style={{backgroundImage:
                                    ...
                                    <div className="row justify-content-center align-content-center m-0 vh-15"
                                        ...
                                        <div className="col-9 px-1 text-left">
                                            <p className="fs-lg fw-7 flh-1 mb-1"><FormattedMessage id="volunteerdash.feed.noprofile1"/></p>
                                            <p className="fs-md fw-4 flh-1 mb-0"><FormattedMessage id="volunteerdash.feed.noprofile2"/></p>
                                        </div>
                                    </div>
                                </div>
                                :""}
                            {profile.pending === false && profile.validated === false ?
                                <div className="col-12 col-lg-6 dash-button-box cp mx-0 mx-lg-2 my-1" style={{backgroundImage:
                                        "linear-gradient( rgba(224, 134, 31, 0.9), rgba(224, 134, 31, 1))"}}>
                                    <div className="row justify-content-center align-content-center m-0 vh-15"
                                         onClick={()=>this.props.navigation("profile","validate")}>
                                        ...
                                        <div className="col-9 px-1 text-left">
                                            <p className="fs-lg fw-7 flh-1 mb-1"><FormattedMessage id="volunteerdash.feed.apply1"/></p>
                                            <p className="fs-md fw-4 flh-1 mb-0"><FormattedMessage id="volunteerdash.feed.apply2"/></p>
                                        </div>
                                    </div>
                                </div>
                                :""}
                            {profile.pending === true ?
                                <div className="col-12 col-lg-6 dash-button-box cp mx-0 mx-lg-2 my-1" style={{backgroundImage:
                                    ...
                                    <div className="row justify-content-center align-content-center m-0 vh-15"
                                        ...
                                        <div className="col-9 px-1 text-left">
                                            <p className="fs-lg fw-7 flh-1 mb-1"><FormattedMessage id="volunteerdash.feed.pending1"/></p>
                                            <p className="fs-md fw-4 flh-1 mb-0"><FormattedMessage id="volunteerdash.feed.pending2"/></p>
                                        </div>
                                    </div>
                                </div>
                                :""}
                            {profile.validated === true ?
                                <div className="col-12 col-lg-6 dash-button-box cp mx-0 mx-lg-2 my-1" style={{backgroundImage:
                                    ...
                                    <div className="row justify-content-center align-content-center m-0 vh-15"
                                         onClick={()=>this.props.navigation("profile","see")}>
                                        <div className="col-3 p-0 text-center align-self-center fs-2xl">
                                            <i className="fas fa-check fa-lg" />
                                        </div>
                                        <div className="col-9 px-1 text-left">
                                            <p className="fs-lg fw-7 flh-1 mb-1"><FormattedMessage id="volunteerdash.feed.validated1"/></p>
                                            <p className="fs-md fw-4 flh-1 mb-0"><FormattedMessage id="volunteerdash.feed.validated2"/></p>
                                        </div>
                                    </div>
                                </div>
                                :""}
