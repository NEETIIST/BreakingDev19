...
class Add extends Component {
    ...
    onSubmit(e) {
        ...
        if (validation.isValid) {
            ...
            axios
                .post(URL+"/api/teams/create", querystring.stringify(newRequest), {
                    headers: {
                ...
                <div className={"row justify-content-center align-items-start m-0"}>
                        ...
                        <form onSubmit={this.onSubmit} autoComplete="off">
                            ...
                            <div className="row justify-content-end align-items-start mx-0 my-3">
                                <div className="col-6 col-lg-3 p-0">
                                    <input type="submit"
                                           value={intl.formatMessage({ id: 'forms.add' })+" "+intl.formatMessage({ id: 'dash.team.title' })}
                    ...
                    <div className={"col-12 text-center p-0 "+(status=="success"?"d-block":"d-none")}>
                        <Fade>
                            ...
                            <p className="fs-sm fw-4 flh-2 mb-0"><FormattedMessage id="dash.team.add.done"/></p>
                        </Fade>
                    </div>
                </div>
            </Fade>
