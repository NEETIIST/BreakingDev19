...
class Files extends Component {
    ...
    uploadPicture(){
        ...
        axios
            .post(URL+"/api/guests/me/files/profile", data, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    "x-access-token": localStorage.getItem("jwtToken").split(" ")[1]
                },
    ...
    removePicture(){
        this.setState({pictureStatus:""});
        axios
            .put(URL+"/api/guests/me/files/profile/remove", {}, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    "x-access-token": localStorage.getItem("jwtToken").split(" ")[1]
                },
    ...
    uploadCV(){
        ...
        axios
            .post(URL+"/api/guests/me/files/cv", data, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    "x-access-token": localStorage.getItem("jwtToken").split(" ")[1]
                },
    ...
    removeCV(){
        this.setState({cvStatus:""});
        axios
            .put(URL+"/api/guests/me/files/cv/remove", {}, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    "x-access-token": localStorage.getItem("jwtToken").split(" ")[1]
                },
